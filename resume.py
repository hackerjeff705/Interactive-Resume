...
while True:
    ...
    if menu == 'A' or menu == 'a':
        ...
        for line in fo:
            #print(line)
            if not line.startswith('Electrophysiology') :
                continue
            else:
                line = line.split(', ')
                for item in line:
