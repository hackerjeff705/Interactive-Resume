...
# Download work_xp.txt and resume.py
...
def comp(menu):
    lst = ['Python Programming', 'Customer service oriented', 'Problem solving, Detail oriented', 'Entrepreneurial', 'Self-learning', 'Verbal/written communication', 'Analytical thinking', 'Adaptability', 'Team Building', 'Leadership & Management']
    return lst
